	...
	<form name="memberForm" method="post">
		...
		<table class="table table-border table-form">
			...
			<tr>
				<td>패스워드 *</td>
				<td>
					<input type="password" name="userPwd" maxlength="10" class="form-control" style="width: 50%;">
			...
			<tr>
				<td>우편번호</td>
				<td>
					<input type="text" name="zip" id="zip" maxlength="7" class="form-control" style="width: 50%;" readonly="readonly">
		...
		<table class="table">
			...
			<tr>
				<td align="center">
					<button type="button" class="btn" name="btnOk" id="btnOk" disabled="disabled" onclick="memberOk();"> 회원가입 </button>
