...
<div class="container">
	...
	<form name="noteForm" action="note_ok.jsp" method="post">
	<table class="table form-table">
		...
		<tr>
		    <td class="left">
		        <select name="itemLeft" multiple="multiple" class="form-select" style="width:130px; height:120px;"></select>
		    </td>
		    <td class="center">
		    ...
		    <td class="left">
		        <select name="itemRight" multiple="multiple" class="form-select" style="width:130px; height:120px;">
		        </select>
		    </td>
		</tr>
		<tr>
