...
<div class="container">
	...
	<table class="table table-form">
		...
		<tr>
			<td>생년월일</td>
			<td>
				<input type="date" name="birth" class="form-control" pattern="yyyy-MM-dd" >
			</td>
		</tr>
		<tr>
			<td>전화번호</td>
	...
	<table class="table">
		<tr align="center">
			<td>
				<button type="button" class="btn" onclick="service();">등록하기</button>
