...
<div class="board">
	...
	<table class="table">
		<tr>
			<td width="50%">
				<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/bbs/pwd.do?num=${dto.num}&mode=update&${query}';">수정</button>
				<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/bbs/pwd.do?num=${dto.num}&mode=delete&${query}';">삭제</button>
				</td>
			<td align="right">
